  ...
  return (
    <div className="management-panel">
      ...
      <div className="management-list shop-list">
        ...
        {category === 'skill' && profile.shop.skillOfferIds.map((skillId) => <article key={skillId}><span><b>{getSkillDisplayName(skillId)}</b><small>G {skillPrice} · 구매 시 고유 인스턴스 생성</small></span><button disabled={storageFull || profile.gold < skillPrice} onClick={() => dispatch({ type: 'BUY_SKILL', skillId })}>구매</button></article>)}
      </div>
